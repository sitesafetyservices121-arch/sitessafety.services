    ...
    <div className="bg-background text-foreground">
      <div className="container max-w-4xl mx-auto py-24 md:py-32 px-4">
        ...
        <div className="prose prose-lg max-w-none font-body text-muted-foreground prose-h2:font-headline prose-h2:text-primary-dark prose-h2:text-2xl prose-h2:border-b-2 prose-h2:border-secondary prose-h2:pb-3 prose-headings:font-headline prose-a:text-primary hover:prose-a:text-primary/80 prose-strong:text-foreground">
          ...
          <p>All content, design, user flows, AI-powered prompts, and any resulting trained models or intellectual property generated by the systems on this website are the sole property of RAK-Site Safety Services (Pty) Ltd. The materials on this site are protected by copyright and intellectual property laws. You may not reproduce, distribute, or transmit any part of this website's design or functionality, including the underlying logic and prompts used by our AI systems, without prior written permission from RAK-Site Safety Services (Pty) Ltd. All rights are reserved.</p>
