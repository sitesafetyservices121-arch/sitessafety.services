        ...
        <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative h-80 lg:h-[400px] w-full">
                    <Image src={imageData.ui.esafety_file_laptop.url} fill style={{objectFit: 'contain'}} alt="e-safety file on a laptop" data-ai-hint={imageData.ui.esafety_file_laptop.hint} priority sizes="(max-width: 1024px) 100vw, 50vw" />
                </div>
            </div>
        </div>
      </section>
