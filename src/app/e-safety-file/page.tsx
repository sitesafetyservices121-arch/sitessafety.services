      ...
      <div className="grid lg:grid-cols-5 gap-12 items-start">
        <div className="lg:col-span-3 space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl font-extrabold text-foreground font-headline">E-Safety File Solutions</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="flex flex-col border-2 border-border bg-card">
              <CardHeader>
            ...
            <Card className="flex flex-col border-2 border-accent shadow-2xl shadow-accent/10 relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-accent text-accent-foreground px-3 py-1 text-sm font-bold font-body rounded-bl-lg">
        ...
        <div className="lg:col-span-2">
            <Card className="shadow-2xl sticky top-24 border-2 border-border bg-card">
            <CardHeader>
