              ...
              <Card className="flex flex-col border bg-background shadow-sm transform hover:-translate-y-2 transition-transform duration-300 hover:shadow-lg">
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className="text-primary-dark font-headline text-2xl">SMB Plan</CardTitle>
                      <CardDescription className="font-body text-base">Ideal for Small to Medium Businesses</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="flex-grow space-y-6">
                  <p className="text-5xl font-bold text-primary-dark font-headline">R119K<span className="text-lg font-body font-normal text-muted-foreground">/one-time</span></p>
              ...
              <Card className="flex flex-col border-2 border-accent shadow-lg shadow-accent/20 relative overflow-hidden bg-background">
                ...
                <CardHeader>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <CardTitle className="text-primary-dark font-headline text-2xl">Enterprise Plan</CardTitle>
                      <CardDescription className="font-body text-base">For Large & Enterprise Companies</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="flex-grow space-y-6">
                  <p className="text-5xl font-bold text-primary-dark font-headline">R250K<span className="text-base font-body font-normal text-muted-foreground">/one-time</span></p>
                  <ul className="space-y-3 font-body text-muted-foreground">
