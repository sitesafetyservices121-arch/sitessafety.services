        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-5 gap-12 md:gap-16 items-start">
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <Card className="flex flex-col border-2 border-accent shadow-2xl shadow-accent/20 relative overflow-hidden bg-card">
                  <div className="absolute top-4 right-4 bg-accent text-accent-foreground px-4 py-1 text-sm font-bold rounded-full flex items-center gap-2">
