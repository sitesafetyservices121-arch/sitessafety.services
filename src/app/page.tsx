...
export default function Home() {
  return (
    <div className="flex flex-col items-center">
      ...
      <section id="services" className="w-full py-16 md:py-24 bg-white dark:bg-card">
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => (
              <Card key={service.title} className="flex flex-col transform hover:-translate-y-2 transition-transform duration-300 shadow-sm hover:shadow-xl border-t-4 border-accent">
                ...
                <CardContent className="flex-grow flex flex-col items-center text-center">
                  ...
                  <Button asChild variant="secondary" className="bg-accent/10 hover:bg-accent/20">
