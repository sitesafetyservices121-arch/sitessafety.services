            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="text-center lg:text-left">
                    ...
                    <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
                        The modern solution for site compliance. Simply upload your required safety file index from clients like Mittal, Sasol, Omnia, Cape Gate, Coca-Cola, or Gold One. Within 12 to 24 hours, log on to download your complete, print-ready, and legally compliant safety file in a single ZIP folder.
                    </p>
                    <div className="mt-8">
