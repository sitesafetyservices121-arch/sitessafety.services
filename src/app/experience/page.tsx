...
const testimonials = [
  ...
  { name: "Pieter van der Merwe", title: "CEO", company: "BuildRight Inc.", testimonial: "The E-Safety File service saved us countless hours and ensured we were fully compliant for a critical audit. The process was smooth, efficient, and professional.", rating: 5, image: "https://placehold.co/100x100.png", hint: "male ceo" },
  ...
  { name: "Bongani Zulu", title: "Site Foreman", company: "Gold One Mining", testimonial: "The electronically delivered safety file was a lifesaver. We got our compliant, print-ready documents in less than a day, which kept our project on schedule. The process was incredibly fast and easy.", rating: 5, image: "https://placehold.co/100x100.png", hint: "male construction worker" },
  { name: "Fatima Allie", title: "Compliance Officer", company: "Omnia Foods", testimonial: "RAK's AI-powered Safety Management System is revolutionary. The built-in consultant helps us identify risks we hadn't even considered. It's an essential tool for maintaining our safety standards.", rating: 5, image: "https://placehold.co/100x100.png", hint: "female inspector" },
  { name: "Jaco Jacobs", title: "Small Business Owner", company: "JJ Engineering", testimonial: "As a smaller operation, we don't have a dedicated safety department. The instant Legal Document Generator is invaluable for creating compliant HIRAs and method statements quickly and affordably.", rating: 5, image: "https://placehold.co/100x100.png", hint: "male engineer" },
  { name: "Sipho Ndlovu", title: "Logistics Manager", company: "Cape Gate Logistics", testimonial: "We rented a safety officer for a complex warehouse setup. The expertise provided was top-notch. They helped us establish safe operating procedures that we still use today. A fantastic service.", rating: 5, image: "https://placehold.co/100x100.png", hint: "male logistics manager" },
  { name: "Naledi Ramphele", title: "Head of Operations", company: "Aviation Giants", testimonial: "The thoroughness of the compliance audit RAK-Site Safety performed was exceptional. They prepared us for our ISO certification and identified critical areas for improvement. Highly professional.", rating: 5, image: "https://placehold.co/100x100.png", hint: "female executive" },
  { name: "Chris Botha", title: "Factory Manager", company: "Sasol Polymers", testimonial: "The Specialised Risk Assessment identified key vulnerabilities in our production line. The detailed report and actionable recommendations have been instrumental in enhancing our operational safety.", rating: 5, image: "https://placehold.co/100x100.png", hint: "male factory manager" },
];
